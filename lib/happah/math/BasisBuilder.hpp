...
#include "happah/geometries/SurfaceSplineHEZ.hpp"
...
#include "happah/utils/SurfaceSplineConstrainerBEZ.hpp"
...
public:
     ...
     std::tuple<const std::vector<Point3D>&, const std::vector<hpuint>&> getDomain() const;
