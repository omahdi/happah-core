...
public:
     ...
     auto& getControlPoint(hpuint i0, hpuint i1, hpuint i2) const { return m_controlPoints[make_control_point_offset(t_degree, i0, i1, i2)]; }
     ...
     template<hpuint i0, hpuint i1, hpuint i2>
     void setControlPoint(Point controlPoint) { m_controlPoints[make_control_point_offset(t_degree, i0, i1, i2)] = std::move(controlPoint); }

     void setControlPoint(hpuint i0, hpuint i1, hpuint i2, Point controlPoint) { m_controlPoints[make_control_point_offset(t_degree, i0, i1, i2)] = std::move(controlPoint); }
