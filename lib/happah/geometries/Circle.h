...
public:
     ...
     static void sample(hpreal radius, hpuint nWedges, hpreal offset, Visitor&& visit) {
     ...
     static void visitNeighborhoodIndices(std::vector<T>& ts, hpuint nWedges, hpuint offset, NeighborhoodIndicesVisitor& visitor) {
